...
class TetraMemClient:
    """High-level client for the TetraMem Cloud API."""

    DEFAULT_BASE_URL = "https://tetramem-xl.com:9110"
    DEFAULT_TIMEOUT = 30
    ...
    def _handle_response(resp: requests.Response) -> dict[str, Any]:
        ...
        raise TetraMemError(message, status_code=code, response_body=body)
    ...
    def __enter__(self) -> TetraMemClient:
        return self
