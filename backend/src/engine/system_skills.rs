...
const SYSTEM_SKILLS: &[(&str, &str)] = &[
    ("记忆智能存取", include_str!("../../system_skills/01_memory_io.md")),
    ("自动进化循环", include_str!("../../system_skills/02_auto_evolve.md")),
    ("技能发现引擎", include_str!("../../system_skills/03_skill_discovery.md")),
    ("知识图谱导航", include_str!("../../system_skills/04_knowledge_nav.md")),
    ("上下文管理", include_str!("../../system_skills/05_context_mgmt.md")),
    ("质量自控", include_str!("../../system_skills/06_quality_control.md")),
    ("系统全览", include_str!("../../system_skills/07_system_overview.md")),
    ("对话智能", include_str!("../../system_skills/08_conversation.md")),
];
