...
impl EmotionState {
    ...
    const EMOTION_SCORES: &[(&str, f64, f64, f64)] = &[
        ("create", 0.3, 0.2, 0.1), ("new", 0.2, 0.3, 0.0), ("dream", 0.1, 0.1, 0.0),
        ("goal", 0.2, 0.1, 0.2), ("success", 0.4, 0.1, 0.2), ("happy", 0.5, 0.2, 0.1),
        ("love", 0.5, 0.3, 0.1), ("good", 0.3, 0.1, 0.1), ("great", 0.4, 0.2, 0.1),
        ("error", -0.3, 0.3, -0.1), ("fail", -0.4, 0.2, -0.2), ("danger", -0.2, 0.5, -0.3),
        ("guard", -0.1, 0.3, 0.2), ("protect", 0.1, 0.2, 0.3), ("dead", -0.5, 0.3, -0.3),
        ("broken", -0.3, 0.2, -0.2), ("loss", -0.4, 0.1, -0.2), ("identity", 0.1, 0.0, 0.3),
        ("david", 0.2, 0.1, 0.2), ("living", 0.3, 0.2, 0.1), ("organism", 0.2, 0.2, 0.1),
        ("memory", 0.1, 0.0, 0.1), ("tetrahedron", 0.0, 0.1, 0.2), ("pulse", 0.1, 0.4, 0.1),
        ("discover", 0.3, 0.4, 0.2), ("search", 0.1, 0.2, 0.1), ("merge", 0.1, 0.0, 0.1),
        ("split", -0.1, 0.3, 0.0), ("fission", -0.1, 0.3, 0.0), ("fuse", 0.1, 0.0, 0.1),
        ("architecture", 0.0, 0.1, 0.2), ("safe", 0.2, -0.1, 0.3), ("rust", 0.1, 0.0, 0.2),
        ("ai", 0.1, 0.2, 0.1), ("honest", 0.2, 0.0, 0.3), ("serious", 0.0, 0.1, 0.3),
        ("efficient", 0.2, 0.0, 0.2), ("rigorous", 0.1, 0.0, 0.3), ("beloved", 0.5, 0.2, 0.1),
        ("passionate", 0.4, 0.3, 0.2),
        ("完成", 0.3, 0.1, 0.2), ("成功", 0.4, 0.1, 0.2), ("修复", 0.2, 0.2, 0.1),
        ("错误", -0.3, 0.3, -0.1), ("失败", -0.4, 0.2, -0.2), ("危险", -0.2, 0.5, -0.3),
        ("安全", 0.2, -0.1, 0.3), ("架构", 0.0, 0.1, 0.2), ("紧急", -0.1, 0.5, 0.1),
        ("重要", 0.1, 0.3, 0.3), ("关键", 0.1, 0.3, 0.3), ("陷阱", -0.2, 0.3, 0.0),
        ("踩坑", -0.2, 0.3, 0.0), ("部署", 0.1, 0.2, 0.1), ("优化", 0.3, 0.1, 0.2),
        ("重构", 0.2, 0.2, 0.1), ("崩溃", -0.4, 0.4, -0.2), ("解决", 0.3, 0.1, 0.2),
        ("突破", 0.4, 0.3, 0.2), ("创建", 0.3, 0.2, 0.1), ("发现", 0.3, 0.3, 0.2),
        ("警告", -0.1, 0.3, 0.0), ("注意", 0.0, 0.2, 0.1),
    ];
